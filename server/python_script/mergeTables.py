...
def main(base_sent_table, text, paths_algs, algs_weight):
    ...
    while number_of_sentence < (len(base_sent_table)-1):
        ...
        for lines in sent_tables:
            tmp_sentence_weight = sentence_calculated_weight(algs_weight, number_of_sentence, algo_index, lines, tmp_sentence_weight)
            algo_index+=1
